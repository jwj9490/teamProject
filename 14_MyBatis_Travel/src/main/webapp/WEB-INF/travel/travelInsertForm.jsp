...
여행 타입 : 
	<input type="radio" name="style" value="패키지"
		<c:if test="${travel.style == '패키지' }">checked</c:if>>패키지	
	<input type="radio" name="style" value="크루즈"
		<c:if test="${travel.style == '크루즈' }">checked</c:if>>크루즈	
	<input type="radio" name="style" value="자유여행"
		<c:if test="${travel.style == '자유여행' }">checked</c:if>>자유여행	
	<input type="radio" name="style" value="골프여행"
		<c:if test="${travel.style == '골프여행' }">checked</c:if>>골프여행
